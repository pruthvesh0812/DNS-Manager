...
exports.bulkAddEditDeleteRecordToHostedZone = void 0;
const awsConfig_1 = require("../awsConfig");
const bulkAddEditDeleteRecordToHostedZone = (paramArr, HostedZoneId) => __awaiter(void 0, void 0, void 0, function* () {
    const params = {
        HostedZoneId: HostedZoneId,
        ChangeBatch: {
            Changes: paramArr.map(param => {
                return {
                    Action: param.Action,
                    ResourceRecordSet: {
    ...
    try {
        const data = yield awsConfig_1.route53.changeResourceRecordSets(params).promise();
...
exports.bulkAddEditDeleteRecordToHostedZone = bulkAddEditDeleteRecordToHostedZone;
// Example usage
